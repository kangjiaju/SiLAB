    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900">
      ...
      <div className="bg-gray-800 bg-opacity-50 p-8 rounded-lg shadow-md w-96 backdrop-filter backdrop-blur-lg relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-2 text-3xl font-bold text-white">注册群智-SiLab</h2>
        </div>
        <form onSubmit={handleRegister}>
          ...
          <div className="mb-4">
            <label htmlFor="email" className="block text-sm font-medium text-gray-300">电子邮箱</label>
            <input
              type="email"
              id="email"
              value={email}
          ...
          <div className="mb-6">
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-300">确认密码</label>
            <input
              type="password"
              id="confirmPassword"
